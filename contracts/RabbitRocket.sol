...
contract RabbitRocket is AccessControlEnumerable, Ownable, EIP712MetaTransaction, PullPayment {
    ...
    constructor(uint32 _startEpoch, uint32 _whitelistEndEpoch, uint32 _countdownSeconds) EIP712MetaTransaction("@RabbitCatch/RabbitRocket","1.0.0") Ownable() {
