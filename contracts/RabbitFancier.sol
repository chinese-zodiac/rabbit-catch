...
contract RabbitFancier is Ownable, EIP712MetaTransaction, PullPayment {

    RabbitRocket rabbitRocket;

    constructor(RabbitRocket _rabbitRocket) EIP712MetaTransaction("@RabbitCatch/RabbitFancier","1.0.0") Ownable() {
